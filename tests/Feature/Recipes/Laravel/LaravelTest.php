...
test('user can set the configuration', function (array $steps) {
    ...
    'default path' => [
        'steps' => [
            ...
            'Redis Configuration',
            'Redis Version' => 7,
            'Redis password (leave blank to disable)' => '1234',
            'Should Redis data be persisted between container reboots?' => 'yes',
            'After how many seconds should Redis dump the snapshot?' => '',
            'How many key changes are required to dump the snapshot?' => '',
            'Git Configuration',
            'Should code be deployed from a git repository?' => 'no',
            'SUCCESS!',
